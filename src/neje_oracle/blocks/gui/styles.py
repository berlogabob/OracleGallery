...
__TOKENS_PLACEHOLDER__
  ...
  /* Quasar notify actions inherit the accent, which is 1.09:1 on a danger fill --
     the re-audit's F-103. Actions ride the notification's own fill, so surface text. */
  .q-notification__actions .q-btn { color: var(--surface) !important; }
  .oracle-micro-label {
