...
REPO_DIR="$(find_repo_dir)" || fail "Cannot find OracleGallery project. Put this sessions folder inside the repo or set ORACLE_REPO_DIR in $LOCAL_ENV."
...
clear || true
echo "========================================"
echo "  Oracle Firebase Uploader Setup"
echo "========================================"
...
echo
echo "Setup finished. Now run START_ORACLE_UPLOADER.command from this folder."
pause
